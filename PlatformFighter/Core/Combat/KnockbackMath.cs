...
/// alternate SetKnockback branch (a handful of real Melee moves ignore this
/// formula and use a fixed value instead — Hitbox has no SetKnockback field
/// yet) or staling/freshness (ds vs. du).
///
...
public static class KnockbackMath
{
        ...
        bool crouching = false, bool vectorCancel = false)
    {
        ...
        Fx kb = scaled * (hit.KnockbackGrowth / OneHundred) + hit.KnockbackBase;
